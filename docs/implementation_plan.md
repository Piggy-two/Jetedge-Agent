...
> **⚠️ 阶段编号说明（2026-08-01）**：本文档的阶段编号为项目早期方案。自 2026-08-01 起，阶段编号以 `README.md` 为准。主要变化：旧方案"阶段 2"（四路 streammux）已完成并归入新方案 Stage 5；旧方案"阶段 3"（TensorRT+Tracker+四路检测）被拆分为新方案 Stage 4（单路 TensorRT+nvinfer）和 Stage 5（四路+Tracker+Metrics）。执行时请以 `README.md` 和 `PROGRESS.md` 中的阶段定义为准。
